...
/**
 * The filters the contributors list accepts, and the ones it refuses.
 *
 ...
 * it did not apply.
 */
final class ContributorIndexRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => ['nullable', Rule::enum(ContributorType::class)],
            ...
            'cursor' => [
                ...
                function (string $attribute, mixed $value, Closure $fail): void {
                    if (is_string($value) && $value !== '' && ! ContributorIndexQuery::describesThisOrdering($value)) {
    ...
    public function filters(): array
    {
        ...
        foreach (['search', 'type', 'country'] as $key) {
